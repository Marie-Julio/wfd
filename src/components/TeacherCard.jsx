...
const TeacherProfileCard = ({ teacher }) => {
  return (
    ...
    <div className=" bg-white group relative overflow-hidden rounded-md shadow dark:shadow-gray-800 hover:shadow-lg dark:hover:shadow-gray-800 duration-500 ease-in-out">
    ...
    <div className="p-6 pt-0 -mt-10 text-center">
        ...
        alt={`${teacher.name}'s profile`} className="size-30 p-1 rounded-full bg-white dark:bg-slate-900 shadow-lg dark:shadow-gray-800 mx-auto" />

        <div className="mt-4">
            <h5 className="text-xl font-semibold mb-3">{teacher.prenom} {teacher.nom}</h5>
