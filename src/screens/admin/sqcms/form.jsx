...
const FormSQcm = () => {
    ...
    const updateData = (values) => {
        ...
        console.log(newData)
        patchResource("/sqcms", id, newData).then((res) => {
            // console.log(res)
    ...
    const saveData = (data) => {
        ...
        console.log(newData)
        postResource("/sqcms", newData).then((res) => {
    ...
    return ( 
        <Body isOpen={isOpen} setIsOpen={setIsOpen}>
            <FormBody title={id ? "Mise a jour Test des sequences" : "Creation de Test des sequences"}>
