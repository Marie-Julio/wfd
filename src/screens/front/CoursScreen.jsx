...
const CoursScreen = () => {
  ...
  return (
    ...
    >
<section className="flex items-start justify-center min-h-screen w-full">
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 flex lg:space-x-8">
    {/* Sidebar (Filtres) */}
    <div className="lg:w-1/4 w-full bg-orange-500 text-white p-4 rounded shadow flex-shrink-0">
      ...
      <div className="mt-8 bg-orange-500 text-white">
