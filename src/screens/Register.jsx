...
const Register = () => {
  ...
  return (
    ...
    <div className="md:overflow-y-auto mx-auto flex md:w-3/5 px-5 md:p-0 justify-center py-10 items-center bg-white">
      <form className="space-y-4 m-auto mt-10 " onSubmit={formik.handleSubmit}>
        <br /><br />
        <h1 className="text-gray-800 font-bold text-2xl mb-1">S'inscrire</h1>
        <p className="text-sm font-normal text-gray-600 mb-7">Inscrivez-vous pour avoir un compte</p>
          <div className="">
                <div className="flex space-x-4">
                  <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 w-1/2">
              ...
              <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                <div className="flex space-x-4">
                    <Input label="Date de naissance" name="date_naissance" placeholder="Entrez votre date de naissance" type="date"
                     value={formik.values.date_naissance} onChange={formik.handleChange}/>
                    <Select name="nationalite" label="La nationalité" value={formik.values.nationalite} 
                    onChange={formik.handleChange} disabled={false}>
